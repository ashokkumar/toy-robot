...
describe TableTop do
  ...
  describe "valid" do
    it "should return true if given x coordinate is with in the table top's length" do
      coordinate = Coordinate.new(3, 2)
      expect(table.has_coordinate?(coordinate)).to be_truthy
    end

    it "should return true if given y coordinate is with in the table top's breath" do
